...
export default function Purchased() {
    ...
    return (
        <div style={{ minHeight: '100%', background: BG }}>
            <SEO title="Purchased" description="Access your wishlist items that you've purchased." />
            {/* ── Hero Section ── */}
            <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem' }}>
                    ...
                    <div>
                        <h1 style={{ fontSize: '1.75rem', fontWeight: 900, margin: 0, letterSpacing: '-0.02em', color: '#fff' }}>Purchased Items</h1>
                        ...
                        <div style={{
                            ...
                            <div>
                                ...
                                <p style={{ fontSize: '0.92rem', color: 'var(--text-dim)', maxWidth: '240px', lineHeight: 1.5 }}>
                                    Your purchased items will appear here safely. Go grab something from your list!
                                </p>
                            </div>
                            <button
                                onClick={() => navigate('/')}
